...
fun Application.module(jdbcUrl: String, username: String, password: String) {
    ...
    install(Routing) {
        get("/") {
            ...
            println("TONY IN GET")
            println(FreeMarkerContent("index.ftl", mapOf("products" to products)).toString())
        ...
        post("/api/v1/products") {
            ...
            productService.decrementBy(purchase) // TODODONE - DIRTY READS - Replace with decrementBy. Why is using update problematic?
